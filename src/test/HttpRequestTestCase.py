...
class HttpRequestTestCase(TestCase):
    ...
    def test_request_url_and_get_the_response(self, mock_urllib3):
        mock_urllib3.return_value = Mock()
        mock_urllib3_class_request = mock_urllib3.return_value.request.return_value
        mock_urllib3_class_request.status = self.status_1
        mock_urllib3_class_request.data = None
    ...
    @patch('urllib3.PoolManager')
    def test_request_another_url_and_get_the_response(self, mock_urllib3):
        mock_urllib3.return_value = Mock()
        mock_urllib3_class_request = mock_urllib3.return_value.request.return_value
        mock_urllib3_class_request.status = self.status_2
        mock_urllib3_class_request.data = None
    ...
    @patch('urllib3.PoolManager')
    def test_get_response_data(self, mock_urllib3):
        mock_urllib3.return_value = Mock()
        mock_urllib3_class_request = mock_urllib3.return_value.request.return_value
        mock_urllib3_class_request.data = self.data_1
    ...
    @patch('urllib3.PoolManager')
    def test_get_response_data_with_json_object(self, mock_urllib3):
        from json import loads
        expected_data_json = loads('{"nothing":[{"no":true}, {"thing":false}]}')

        mock_urllib3.return_value = Mock()
        mock_urllib3_class_request = mock_urllib3.return_value.request.return_value
        mock_urllib3_class_request.data = self.data_json_2
    ...
    @patch('urllib3.PoolManager')
    def test_get_response_data_with_invalid_json_object(self, mock_urllib3):
    ...
    @patch('urllib3.PoolManager')
    def test_get_response_invalid_data_check_the_json_object(self, mock_urllib3):
        mock_urllib3.return_value = Mock()
        mock_urllib3_class_request = mock_urllib3.return_value.request.return_value
        mock_urllib3_class_request.data = None
    ...
    @patch('urllib3.PoolManager')
    def test_get_response_json_for_data_object(self, mock_urllib3):
        from json import loads
        expected_data_json = loads('{"data":[{"hi":"Man"}, {"orko":null}]}')['data']

        mock_urllib3.return_value = Mock()
        mock_urllib3_class_request = mock_urllib3.return_value.request.return_value
        mock_urllib3_class_request.data = self.data_json_1
    ...
    @patch('urllib3.PoolManager')
    def test_get_response_json_for_data_object_when_not_exists(self, mock_urllib3):
        mock_urllib3.return_value = Mock()
        mock_urllib3_class_request = mock_urllib3.return_value.request.return_value
        mock_urllib3_class_request.data = self.data_json_2
